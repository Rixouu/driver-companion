-- Fix template to match quotation details page logic
-- Charter Services: time_based_discount = null (completely hidden)
-- Airport Services: time_based_discount = actual value (shown)
