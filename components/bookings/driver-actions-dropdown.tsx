...
export function DriverActionsDropdown({ booking }: DriverActionsDropdownProps) {
  ...
  return (
    <div className="relative group">
      ...
      <div className="absolute right-0 mt-2 w-72 z-50 rounded-md shadow-lg bg-white dark:bg-black text-gray-900 dark:text-white border border-gray-200 dark:border-gray-800 hidden group-hover:block">
        ...
        <div className="p-3 border-b border-gray-200 dark:border-gray-800">
          <div className="space-y-4">
            <a 
              ...
              className="flex items-center gap-3 hover:bg-gray-100 dark:hover:bg-gray-900 p-2 rounded-sm"
            >
            ...
            <button 
              className="flex items-center gap-3 hover:bg-gray-100 dark:hover:bg-gray-900 p-2 rounded-sm w-full text-left"
