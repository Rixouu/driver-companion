  ...
  return (
    <Card>
      ...
      <SendQuotationDialog
        ...
        emailAddress={emailAddress}
        setEmailAddress={setEmailAddress}
        sendQuotationLanguage={sendQuotationLanguage}
        setSendQuotationLanguage={setSendQuotationLanguage}
        sendQuotationBccEmails={sendQuotationBccEmails}
        setSendQuotationBccEmails={setSendQuotationBccEmails}
        isSendingQuotation={isSendingQuotation}
        onSendQuotation={handleSendQuotationWithSettings}
      />
    </Card>
  );
});
