-- Enhanced Quotation Sent Email Template with improved CTA and Next Steps blocks
...
<div style="background: #f8f9fa; padding: 24px; border-radius: 8px; margin: 20px 0; border-left: 4px solid #2d3748;">
  <div style="text-align: center;">
    <!-- Icon -->
    <div style="background: #2d3748; width: 50px; height: 50px; border-radius: 50%; margin: 0 auto 16px; display: flex; align-items: center; justify-content: center;">
      <div style="color: white; font-size: 20px;">📋</div>
    </div>
    
    <!-- Title -->
    <h3 style="margin: 0 0 12px 0; color: #2d3748; font-size: 18px; font-weight: bold;">{{language == "ja" ? "次のステップ" : "Next Steps"}}</h3>
    
    <!-- Content -->
    <div style="background: white; padding: 20px; border-radius: 6px; text-align: left;">
      <p style="margin: 0 0 12px; color: #4a5568; font-size: 14px; line-height: 1.6;">{{language == "ja" ? "見積書をご確認いただき、ご質問がございましたらお気軽にお問い合わせください。" : "Please review the quotation and contact us if you have any questions."}}</p>
      <p style="margin: 0; color: #4a5568; font-size: 14px; line-height: 1.6;">{{language == "ja" ? "お客様のご利用をお待ちしております。" : "We look forward to serving you."}}</p>
    </div>
  </div>
</div>
