...
async function addVehicleFieldsToBookings() {
  console.log('Adding vehicle-related columns to bookings table...');
  
  try {
    // Use raw SQL query to add the columns
    ...
    console.log('Successfully added vehicle-related columns to bookings table.');
    return true;
  } catch (error) {
