...
export const ja: TranslationValue = {
  ...
  quotations: {
    ...
    empty: {
      title: "見積書が見つかりません",
      description: "まだ見積書がありません。最初の見積書を作成してください。",
      cta: "見積書を作成する"
    },
    filters: {
      status: "ステータス",
    ...
    details: {
      ...
      notes: "メモ",
      activities: "活動履歴",
      editQuotation: "見積書を編集",
      deleteQuotation: "見積書を削除",
      sendQuotation: "見積書を送信",
    ...
    form: {
      ...
      sendToCustomer: "保存して顧客に送信",
      create: "見積書を作成",
      placeholders: {
        title: "例: ABC会社のための空港送迎",
        customerName: "氏名",
        customerEmail: "メールアドレス",
        customerPhone: "電話番号",
        pickupLocation: "集合住所を入力",
        dropoffLocation: "目的地住所を入力",
        merchantNotes: "あなたとチームのみに表示されるメモ",
        customerNotes: "顧客に表示されるメモ"
      },
      validation: {
        titleRequired: "タイトルが必要です",
        customerEmailRequired: "顧客のメールアドレスが必要です",
        customerEmailInvalid: "有効なメールアドレスを入力してください",
        serviceTypeRequired: "サービスタイプが必要です",
        vehicleTypeRequired: "車両タイプが必要です"
      }
    },
    serviceTypes: {
      charter: "チャーター",
      airportTransferHaneda: "空港送迎 - 羽田",
      airportTransferNarita: "空港送迎 - 成田"
    },
    pricing: {
      category: "カテゴリー",
      vehicleType: "車両タイプ",
    ...
    email: {
      subject: "{companyName}からの見積書",
      greeting: "{customerName}様",
      intro: "弊社サービスにご関心いただきありがとうございます。以下に見積書の詳細をご案内いたします。",
      linkCta: "見積書を表示",
      validUntil: "この見積書は{date}まで有効です。",
      contactInfo: "ご質問がある場合は、{email}または{phone}までお問い合わせください。",
      signature: "敬具\n{companyName}チーム",
      reminderSubject: "リマインダー：{companyName}からの見積書",
      reminderIntro: "お送りした見積書についてのリマインダーをお送りします。見積書は{date}に期限切れとなります。",
      approvedSubject: "見積書承認済み",
      rejectedSubject: "見積書への回答",
      conversionSubject: "承認された見積書の予約確認",
      conversionIntro: "見積書を承認いただきありがとうございます。予約が正常に作成されました。"
    },
    customer: {
      viewPanel: {
        title: "見積書 #{id}",
        ...
        expired: "期限切れ：{date}",
        status: "ステータス：{status}",
        description: "弊社サービスの見積書をお送りします。以下の詳細をご確認ください。",
        yourDetails: "お客様情報",
        serviceDetails: "サービス詳細",
        pricing: "価格",
        approveButton: "見積書を承認",
        ...
        approvalSuccess: "見積書が正常に承認されました",
        rejectionSuccess: "見積書が正常に却下されました",
        expiredMessage: "この見積書は期限切れです。新しい見積書については、お問い合わせください。",
        convertedMessage: "この見積書は予約に変換されました。",
        approvedMessage: "この見積書を承認しました。まもなく予約が作成されます。",
        rejectedMessage: "この見積書を却下しました。気が変わりましたら、お問い合わせください。",
        commentsLabel: "追加コメント",
        commentsPlaceholder: "コメントや特別なリクエストを追加（任意）",
        rejectionLabel: "却下理由",
        rejectionPlaceholder: "見積書を却下する理由をお聞かせください",
        vehicleType: "車両タイプ",
        serviceType: "サービスタイプ",
        pickupLocation: "集合場所",
        dropoffLocation: "目的地",
    ...
    notifications: {
      ...
      deleteConfirmation: "この見積書を削除してもよろしいですか？この操作は元に戻せません。"
    }
  } as const
}