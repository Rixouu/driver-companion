-- Phase 3A: Critical Security Fixes
-- Fix exposed auth.users, security definer views, and missing RLS

-- =============================================
-- 1. FIX EXPOSED AUTH.USERS VIA USER_PROFILES VIEW
-- =============================================

-- Drop the problematic user_profiles view that exposes auth.users
DROP VIEW IF EXISTS public.user_profiles;

-- Create a secure user_profiles view that doesn't expose auth.users directly
-- This view will only show public profile data, not auth.users data
