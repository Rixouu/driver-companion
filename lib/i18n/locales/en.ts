...
export const en: TranslationValue = {
  ...
  quotationWorkflow: {
    ...
    sending: "Sending...",
    regenerateResend: "Regenerate & Resend",
    skipBankTransfer: "Skip (Bank Transfer)",
    cancel: "Cancel",
    sendQuotationTitle: "Send Quotation",
    sendPaymentLinkTitle: "Send Payment Link",
    markAsPaidTitle: "Mark Quotation as Paid",
    markAsPaidDescription: "Mark this quotation as paid and optionally upload a receipt.",
    paymentDate: "Payment Date",
    paymentAmount: "Payment Amount",
    paymentMethod: "Payment Method",
    receipt: "Receipt",
    checkOmisePayment: "Check Omise Payment Status",
    checkingPayment: "Checking Payment...",
    omiseReceiptAvailable: "Omise Receipt Available",
    issued: "Issued:",
    download: "Download",
    acceptedFormats: "Accepted formats: PDF, JPG, PNG, DOC, DOCX",
    receiptUploaded: "Receipt uploaded",
    downloadReceipt: "Download Receipt",
    sendPaymentCompleteEmail: "Send Payment Completion Email",
    language: "Language",
    bccEmails: "BCC Emails",
    paymentCompletionEmail: "Payment Completion Email",
    whatIncludedEmail: "What's included in the email:",
    completeInvoiceDetails: "Complete invoice details and service information",
    customerInformation: "Customer information and billing details",
    serviceBreakdown: "Service breakdown and pricing",
    invoicePdfAttachment: "Invoice PDF attachment",
    securePaymentLink: "Secure payment link for online payment",
    paymentInstructions: "Payment instructions and terms",
    companyBranding: "Company branding and contact information",
    paymentLinkName: "Payment Link Name (Optional)",
    customNamePaymentLink: "Custom name for the payment link. Leave empty to use default.",
    paymentLinkSent: "Payment link sent on",
    paymentLink: "Payment Link",
    generate: "Generate",
    clickGenerate: "Click Generate to create a new Omise payment link",
    bankTransferOption: "Bank Transfer Option",
    bankTransferDescription: "If the customer prefers bank transfer, you can skip sending a payment link and mark this step as complete. The customer will receive bank transfer instructions separately.",
    customerEmail: "Customer Email",
    emailWillBeSent: "Email will be sent to the customer's registered email address",
    defaultBccEmails: "Default: booking@japandriver.com. Add more emails separated by commas.",
    enterEmailAddresses: "Enter email addresses separated by commas",
    whatIncludedQuotation: "What's included in the email:",
    completeQuotationDetails: "Complete quotation details and service information",
    customerContactDetails: "Customer information and contact details",
    quotationPdfAttachment: "Quotation PDF attachment",
    magicLink: "Magic link for customer access",
    paymentCompletionConfirmation: "Payment completion confirmation",
    paymentMethodAmount: "Payment method and amount details",
    invoicePdfMarkedPaid: "Invoice PDF attachment (marked as paid)",
    thankYouMessage: "Thank you message and next steps",
    processing: "Processing...",
    markAsPaidSendEmail: "Mark as Paid & Send Email",
    markAsPaidOnly: "Mark as Paid"
  },
  priceDetails: {
    selectedServices: "Selected Services",
    package: "Package",
