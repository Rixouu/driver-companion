      ...
      <div className="container max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        ...
        <Card>
          <CardContent className="p-8 text-center">
            ...
            <Button asChild>
              <Link href="/drivers" ><span className="flex items-center gap-2"><span className="flex items-center gap-2"><span>{t("common.backTo")} {t("drivers.title")}</span></span></span></Link>
            </Button>
          </CardContent>
        </Card>
      </div>
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            ...
            <TabsContent value="assign" className="mt-4 space-y-4">
              ...
              <div className="flex justify-end gap-4">
                <Link href={`/drivers/${id}`} ><span className="flex items-center gap-2">
