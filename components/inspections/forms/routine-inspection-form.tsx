...
import type { InspectionCategory, InspectionItem, InspectionItemTemplate } from "@/lib/types/inspections"

interface RoutineInspectionFormProps {
...
export function RoutineInspectionForm({ onSectionComplete, onPhotoAdd, onNotesChange }: RoutineInspectionFormProps) {
  const { t } = useI18n()
  ...
  useEffect(() => {
    async function loadTemplates() {
      try {
        const categories = await getInspectionTemplates('routine')
  ...
  const getSectionProgress = (section: typeof sections[0]) => {
