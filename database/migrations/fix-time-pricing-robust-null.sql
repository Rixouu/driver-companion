-- Robust fix: Handle null values properly by using explicit conditions
-- This will prevent the time adjustment block from showing when time_based_discount is null
