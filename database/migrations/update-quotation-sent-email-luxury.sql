-- Luxury Quotation Sent Email Template with sophisticated Next Steps design
-- Designed for premium private limousine service
...
<!-- Next Steps Block - Luxury Design -->
<div style="background: linear-gradient(135deg, #1f2937 0%, #111827 100%); padding: 32px; border-radius: 12px; margin: 24px 0; border: 1px solid #374151; box-shadow: 0 10px 25px rgba(0, 0, 0, 0.15);">
  <div style="text-align: center;">
    <!-- Luxury Icon -->
    <div style="background: linear-gradient(135deg, #d4af37, #b8860b); width: 72px; height: 72px; border-radius: 50%; margin: 0 auto 20px; display: flex; align-items: center; justify-content: center; box-shadow: 0 8px 16px rgba(212, 175, 55, 0.3);">
      <div style="color: white; font-size: 28px; font-weight: bold;">★</div>
    </div>
    
    <!-- Title -->
    <h3 style="margin: 0 0 16px 0; color: #f9fafb; font-size: 20px; font-weight: 600; letter-spacing: 0.5px;">{{language == "ja" ? "次のステップ" : "Next Steps"}}</h3>
    
    <!-- Subtitle -->
    <p style="margin: 0 0 24px 0; color: #d1d5db; font-size: 14px; font-style: italic;">{{language == "ja" ? "プレミアムサービスへのご案内" : "Your journey to premium service"}}</p>
    
    <!-- Content -->
    <div style="background: rgba(255, 255, 255, 0.05); padding: 24px; border-radius: 8px; text-align: left; backdrop-filter: blur(10px); border: 1px solid rgba(255, 255, 255, 0.1);">
      
      <!-- Step 1 -->
      <div style="display: flex; align-items: flex-start; gap: 16px; margin-bottom: 20px; padding-bottom: 20px; border-bottom: 1px solid rgba(255, 255, 255, 0.1);">
        <div style="background: linear-gradient(135deg, #d4af37, #b8860b); width: 32px; height: 32px; border-radius: 50%; display: flex; align-items: center; justify-content: center; flex-shrink: 0; margin-top: 2px; box-shadow: 0 4px 8px rgba(212, 175, 55, 0.3);">
          <span style="color: white; font-size: 14px; font-weight: bold;">1</span>
        </div>
        <div>
          <p style="margin: 0 0 6px 0; color: #f9fafb; font-size: 15px; font-weight: 600; letter-spacing: 0.3px;">{{language == "ja" ? "見積書のご確認" : "Review Your Quotation"}}</p>
          <p style="margin: 0; color: #d1d5db; font-size: 13px; line-height: 1.6;">{{language == "ja" ? "上記のセキュアリンクから、お客様専用の見積書詳細をご確認ください。すべてのサービス内容と料金が明記されています。" : "Please review your personalized quotation details through the secure link above. All service specifications and pricing are clearly outlined for your convenience."}}</p>
        </div>
      </div>
      ...
      <div style="display: flex; align-items: flex-start; gap: 16px; margin-bottom: 20px; padding-bottom: 20px; border-bottom: 1px solid rgba(255, 255, 255, 0.1);">
        ...
        <div>
          <p style="margin: 0 0 6px 0; color: #f9fafb; font-size: 15px; font-weight: 600; letter-spacing: 0.3px;">{{language == "ja" ? "専任コンシェルジュへのお問い合わせ" : "Contact Your Personal Concierge"}}</p>
          <p style="margin: 0; color: #d1d5db; font-size: 13px; line-height: 1.6;">{{language == "ja" ? "ご質問やご要望がございましたら、専任のコンシェルジュが24時間以内にお答えいたします。お客様のご希望に合わせてサービスをカスタマイズいたします。" : "Should you have any questions or special requests, our dedicated concierge team will respond within 24 hours. We are committed to customizing our services to exceed your expectations."}}</p>
        </div>
      </div>
      ...
      <div style="display: flex; align-items: flex-start; gap: 16px;">
        ...
        <div>
          <p style="margin: 0 0 6px 0; color: #f9fafb; font-size: 15px; font-weight: 600; letter-spacing: 0.3px;">{{language == "ja" ? "プレミアムサービスへのご案内" : "Experience Premium Service"}}</p>
          <p style="margin: 0; color: #d1d5db; font-size: 13px; line-height: 1.6;">{{language == "ja" ? "お客様の特別な瞬間を、最高のサービスでお手伝いいたします。プロフェッショナルなドライバーと最新の車両で、安全で快適な移動をお約束いたします。" : "We look forward to making your special moments extraordinary with our premium service. Our professional drivers and state-of-the-art vehicles ensure a safe, comfortable, and luxurious journey."}}</p>
        </div>
      </div>
    </div>
    ...
    <div style="margin-top: 20px; padding-top: 20px; border-top: 1px solid rgba(255, 255, 255, 0.1);">
      <p style="margin: 0; color: #9ca3af; font-size: 12px; font-style: italic;">{{language == "ja" ? "24時間対応の専任コンシェルジュサービス" : "24/7 Dedicated Concierge Service"}}</p>
    </div>
  </div>
</div>
