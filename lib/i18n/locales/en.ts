...
export const en: TranslationValue = {
  ...
  quotations: {
    ...
    empty: {
      ...
      description: "There are no quotations yet. Create your first quotation to get started.",
    ...
    filters: {
      ...
      clearFilters: "Clear Filters",
      dateRange: "Date Range",
      noResults: "No quotations match your criteria"
    },
    list: {
    ...
    form: {
      ...
      create: "Create Quotation",
      placeholders: {
        title: "e.g., Airport Transfer for ABC Company",
        customerName: "Full name",
        customerEmail: "Email address",
        customerPhone: "Phone number",
        pickupLocation: "Enter pickup address",
        dropoffLocation: "Enter dropoff address",
        merchantNotes: "Notes visible only to you and your team",
        customerNotes: "Notes visible to the customer"
      },
      validation: {
    ...
    serviceTypes: {
      charter: "Charter",
      airportTransferHaneda: "Airport Transfer - Haneda",
      airportTransferNarita: "Airport Transfer - Narita"
    },
    pricing: {
      category: "Category",
      vehicleType: "Vehicle Type",
    ...
    email: {
      subject: "Quotation from {companyName}",
      greeting: "Dear {customerName}",
      intro: "Thank you for your interest in our services. Please find your quotation details below.",
      linkCta: "View Quotation",
      validUntil: "This quotation is valid until {date}.",
      contactInfo: "If you have any questions, please contact us at {email} or {phone}.",
      signature: "Regards,\n{companyName} Team",
      reminderSubject: "Reminder: Your Quotation from {companyName}",
      reminderIntro: "This is a friendly reminder about the quotation we sent you. The quotation will expire on {date}.",
      approvedSubject: "Quotation Approved",
      rejectedSubject: "Quotation Response",
      conversionSubject: "Booking Confirmation for Your Approved Quotation",
      conversionIntro: "Thank you for approving our quotation. Your booking has been created successfully."
    },
    customer: {
      viewPanel: {
        title: "Quotation #{id}",
        ...
        description: "You have received a quotation for our services. Please review the details below.",
        ...
        approvalSuccess: "Quotation approved successfully",
        rejectionSuccess: "Quotation rejected successfully",
        expiredMessage: "This quotation has expired. Please contact us for a new quotation.",
        convertedMessage: "This quotation has been converted to a booking.",
        approvedMessage: "You have approved this quotation. A booking will be created shortly.",
        rejectedMessage: "You have rejected this quotation. If you change your mind, please contact us.",
        commentsLabel: "Additional Comments",
        commentsPlaceholder: "Add any comments or special requests (optional)",
        rejectionLabel: "Rejection Reason",
        rejectionPlaceholder: "Please let us know why you're rejecting this quotation",
        vehicleType: "Vehicle Type",
        serviceType: "Service Type",
        pickupLocation: "Pickup Location",
        dropoffLocation: "Dropoff Location",
    ...
    notifications: {
      ...
      deleteConfirmation: "Are you sure you want to delete this quotation? This action cannot be undone."
    },
