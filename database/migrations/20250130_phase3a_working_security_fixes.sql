-- Phase 3A: Working Security Fixes
-- Fix security issues with exact data type matching
...
-- Create a secure version of user_profiles with exact data types
CREATE VIEW public.user_profiles AS
SELECT 
  p.id,
  p.email::character varying(255) AS email,  -- Match existing varchar(255) type
  p.full_name,
