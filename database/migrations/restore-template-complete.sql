-- Complete template restoration to fix the broken template
-- This will restore the template to a working state
...
<div style="background: #FF2800; padding: 24px; border-radius: 8px; margin: 20px 0; text-align: center;box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1);">
  ...
  <div style="margin-top: 16px; padding-top: 16px; border-top: 1px solid rgba(255, 255, 255, 0.2);">
    ...
    <p style="margin: 0; font-size: 11px; word-break: break-all; background: rgba(255, 255, 255, 0.2); padding: 8px 12px; border-radius: 4px;"><a href="{{magic_link}}" class="magic-link" style="color: white !important; text-decoration: none !important;">{{magic_link}}</a></p>
  </div>
</div>
