  ...
  dashboard: {
    ...
    quotations: {
      ...
      form: {
        ...
        placeholders: {
          ...
          merchantNotes: "内部メモ（自分のみに表示）",
          customerNotes: "顧客へのメモ（顧客に表示）",
          companyName: "会社名を入力",
        ...
        services: {
          ...
          noServicesAdded: "まだサービスが追加されていません。下のボタンで最初のサービスを追加してください。",
          serviceType: "サービスタイプ",
          ...
          servicesIncluded: "{count}件のサービスが含まれています",
          basePrice: "基本料金",
          timeAdjustment: "時間調整",
          total: "合計",
          pickupDate: "迎車日",
        ...
        packages: {
          ...
          packagesCount: "パッケージ",
          moreItems: "その他の項目",
          selectToSeePricing: "価格を表示するにはサービスまたはパッケージを選択してください",
        ...
        promotions: {
          ...
          invalid: "無効なプロモーションコード",
          expired: "プロモーションは期限切れです",
          notActive: "プロモーションはまだ有効ではありません",
          usageLimitReached: "プロモーションの使用制限に達しました",
          minimumAmount: "最低注文金額：",
          availablePromotions: "利用可能なプロモーション",
          noPromotions: "有効なプロモーションはありません",
          enterCode: "プロモーションコードを入力",
          discount: "割引",
          promotionApplied: "プロモーション適用！",
          maxDiscount: "最大: {amount}"
        },
        timePricing: {
          title: "時間ベースの価格設定",
          automatic: "自動時間ベース調整",
          description: "時間ベースの価格ルールは、迎車日時に基づいて自動的に適用されます。",
          features: {
            peakHours: "ピーク時間（朝/夕方のラッシュ）",
            nightSurcharge: "夜間割増料金（深夜/早朝）",
            weekendPricing: "週末の価格調整",
            holidayPricing: "祝日および特別イベント期間"
          },
          status: {
            title: "現在のステータス",
            active: "時間ベースのルールが自動的に適用されます",
            inactive: "時間ベースの価格設定を適用するには、迎車日時を設定してください"
          },
          howItWorks: {
            title: "仕組み",
            description: "迎車日時を設定すると、システムは適用可能な時間ベースの価格ルールを自動的にチェックし、基本価格に適切な調整を適用します。調整後の価格は最終的な見積に反映されます。"
          }
        },
        steps: {
        ...
        preview: {
          ...
          appliedToServices: "{count}件のサービスに適用",
          readyToSend: "送信準備完了",
          reviewMessage: "この見積を顧客に送信する前に、上記のすべての情報を確認してください。送信されると、顧客は見積の詳細と表示または返信するためのリンクが記載されたメールを受け取ります。",
          pricingSummary: "価格概要",
      ...
      notifications: {
        createSuccess: "見積が正常に作成されました",
        updateSuccess: "見積が正常に更新されました",
        deleteSuccess: "見積が正常に削除されました",
      ...
      messageBlock: {
        ...
        startConversation: "この見積について顧客と会話を開始します",
      ...
      activities: {
        ...
        updated: "見積が更新されました",
        sent: "見積が顧客に送信されました",
        approved: "見積が顧客によって承認されました",
        rejected: "見積が顧客によって拒否されました",
        converted: "見積が予約に変換されました",
        ...
        feed: {
          ...
          updated: "{userName}が見積の詳細を更新しました",
      ...
      details: {
        ...
        phone: "電話番号",
        billingAddress: "請求先住所",
        invoicingDetails: "請求および請求書発行の詳細",
        companyName: "会社名",
        address: "住所",
        taxId: "税ID",
        ...
        noFilteredActivities: "このタイプのアクティビティは見つかりません",
        ...
        discount: "割引",
        serviceConfiguration: "サービスの設定と詳細",
        serviceDuration: "サービス期間",
        total: "合計",
        passengerCount: "乗客数",
        serviceSchedule: "サービスのスケジュールとタイミング",
        ...
        specialOffer: "割引付きの特別パッケージディール",
        discountApplied: "割引が正常に適用されました",
        validPeriod: "有効期間",
        automaticAdjustments: "時間に基づいた自動価格調整",
        approvalPanel: {
          title: "見積承認",
          approveButton: "見積を承認",
          rejectButton: "見積を拒否",
          ...
          description: "この見積を確認し、承認して進めるか、詳細なフィードバックを付けて拒否してください。",
          approveDescription: "この見積を確認し、予約に進むために承認してください。",
      ...
      editSection: {
        ...
        notEditableDescription: "下書きまたは送信済みステータスの見積のみ編集できます。"
      },
      pricingSummary: "価格概要",
      pricingBreakdown: "価格内訳",
      detailedBreakdown: "詳細な内訳",
    ...
    pricing: {
      ...
      categories: {
        ...
        deleteConfirmDescription: "この操作は元に戻せません。これにより、この価格カテゴリが永久に削除され、既存の価格項目に影響を与える可能性があります。",
        activateConfirmTitle: "カテゴリを有効にしますか？",
        activateConfirmDescription: "これにより、カテゴリが表示され、選択可能になります。",
        deactivateConfirmTitle: "カテゴリを無効にしますか？",
        deactivateConfirmDescription: "これにより、新しい見積や価格設定フォームでカテゴリが選択できなくなります。",
        toast: {
        ...
        deleteDialog: {
          title: "カテゴリを削除しますか？",
          description: "この操作は元に戻せません。これにより、この価格カテゴリが永久に削除され、既存の価格項目に影響を与える可能性があります。"
        },
        activateDialog: {
          title: "カテゴリを有効にしますか？",
        ...
        deactivateDialog: {
          title: "カテゴリを無効にしますか？",
          description: "これにより、新しい見積や価格設定フォームでカテゴリが選択できなくなります。"
        },
        fields: {
          name: "カテゴリ名",
      ...
      items: {
        title: "価格項目",
        description: "選択したカテゴリの個々の価格項目を管理します",
        active: "有効",
        inactive: "無効",
        toast: {
          fetchFailed: "価格項目の取得に失敗しました",
          initialLoadFailed: "価格設定の初期カテゴリ/サービスの読み込みに失敗しました",
          saveFailed: "価格項目の保存に失敗しました",
          deleteFailed: "価格項目の削除に失敗しました",
          statusToggleFailed: "項目ステータスの切り替えに失敗しました",
          deleteSuccess: "価格項目が正常に削除されました",
          statusUpdateSuccess: "項目ステータスが正常に更新されました"
        },
        errors: {
          categoryRequired: "価格項目にはカテゴリが必要です",
          serviceTypeRequired: "価格項目にはサービスタイプが必要です",
          priceRequired: "価格は必須であり、有効な数値でなければなりません"
        },
        filters: {
          title: "フィルターとアクション",
          ...
          selectCategoryPrompt: "項目を表示するにはカテゴリを選択してください。",
          noCategoriesFound: "価格カテゴリが存在しません。まず作成してください。",
          durationLabel: "期間",
        ...
        buttons: {
          addNew: "新しい価格項目を追加",
          addItemToCategory: "{categoryName}に項目を追加"
        },
        emptyState: {
          selectCategory: "項目を表示または追加するには、価格カテゴリを選択してください。",
          selectCategoryPrompt: "上のカテゴリを選択して、その価格項目を管理します。",
          noItemsFound: "選択したカテゴリ/フィルターに価格項目が見つかりませんでした。"
        },
        loadingItemsFor: "{categoryName}の価格項目を読み込み中...",
        table: {
          serviceType: "サービスタイプ",
          durationHours: "期間（時間）",
          price: "価格",
        ...
        dialog: {
          createTitle: "新しい価格項目を作成",
          editTitle: "価格項目を編集",
          descriptionCreate: "選択したカテゴリに新しい価格項目を追加します。",
          descriptionEdit: "この価格項目の詳細を編集します。",
          ...
          commentsPlaceholder: "この価格項目に関する内部メモ"
        },
        deleteDialog: {
          title: "価格項目を削除しますか？",
          description: "この操作は元に戻せません。これにより、この価格項目が永久に削除されます。"
        },
        statusDialog: {
          activateTitle: "価格項目を有効にしますか？",
          activateDescription: "この項目は見積で使用可能になります。",
          deactivateTitle: "価格項目を無効にしますか？",
          deactivateDescription: "この項目は非表示になり、新しい見積では使用できなくなります。"
        },
        durations: {
          hour: "{count}時間",
          hours: "{count}時間",
        ...
        timeBasedPricing: {
          ...
          createSuccess: "時間ベースの価格ルールが正常に作成されました",
          updateSuccess: "時間ベースの価格ルールが正常に更新されました",
          deleteSuccess: "時間ベースの価格ルールが正常に削除されました",
          addRule: "新しい時間ベースのルールを追加",
          editRule: "時間ベースのルールを編集",
          deleteRule: "時間ベースのルールを削除",
          deleteRuleConfirm: "この時間ベースの価格ルールを削除してもよろしいですか？この操作は元に戻せません。",
          ruleName: "ルール名",
          ruleNamePlaceholder: "例：夜間割増",
          startTime: "開始時間",
          endTime: "終了時間",
          ...
          active: "有効",
          toast: {
            fetchFailed: "時間ベースの価格ルールの読み込みに失敗しました",
          ...
          emptyState: {
            noRulesForCategory: "このカテゴリに時間ベースのルールは見つかりませんでした。",
    ...
    invoices: {
      ...
      sendInvoiceWithPaymentLink: "支払いリンク付きの請求書を送信",
      downloadPDF: "PDFをダウンロード",
      ...
      messages: {
        ...
        markPaidError: "請求書の支払い済みマーク中にエラーが発生しました"
      }
    },
    ...
    activityLog: {
      title: "アクティビティログ",
      description: "このドライバーのすべてのアクティビティを表示します"
    },
    errors: {
    ...
    inspectionTemplates: {
      ...
      assignment: {
        title: "テンプレートの割り当て",
        description: "車両またはグループにテンプレートを割り当てます",
        vehicleGroups: "車両グループ",
        individualVehicles: "個別の車両",
        addGroup: "グループを追加",
      ...
      dialogs: {
        ...
        deleteConfirm: {
          ...
          sectionDescription: "これにより、このセクションとその中のすべての{items}項目が永久に削除されます。この操作は元に戻せません。",
        ...
        section: {
          ...
          nameEn: "名前（英語）",
          nameJa: "名前（日本語）",
          nameEnPlaceholder: "例：エンジンチェック",
          nameJaPlaceholder: "例：エンジン点検",
          descriptionEn: "説明（英語）",
          descriptionJa: "説明（日本語）",
          isActive: "アクティブなセクション"
        },
        vehicleGroup: {
          create: "車両グループを作成",
          edit: "車両グループを編集",
        ...
        manageVehicles: {
          ...
          noAvailableVehicles: "追加できる車両がありません",
          addSelected: "選択項目を追加",
      ...
      inspections: {
        ...
        calendar: {
          ...
          week: "週",
          today: "今日",
          inspectionsOnDate: "{count}件の点検 on {date}",
        ...
        details: {
          ...
          noPhotosMessage: "この点検中に写真撮影はありませんでした",
          photoForItem: "{itemName}の写真",
          ...
          results: {
            ...
            noItemsInStatus: "{status}ステータスの項目はありません",
            itemStatus: "項目ステータス",
            passed: "合格",
            failed: "不合格",
            pending: "保留中",
        ...
        notes: {
          ...
          form: {
            ...
            clearFilters: "フィルターをクリア",
            noVehiclesFound: "車両が見つかりません",
            vehicleSelected: "選択された車両",
            typeSelected: "選択されたタイプ",
            startInspection: "点検を開始",
            progress: {
      ...
      notAuthorized: {
        title: "アクセスが拒否されました",
        description: "このエリアにアクセスする権限がありません。このセクションには日本のドライバーのスタッフのみがアクセスできます。",
