-- Fix footer content format - remove table wrapper, return just the content
-- The quotation generator expects just <p> tags, not <tr><td> wrapper

-- Update Japan Quotation Footer
UPDATE partial_templates 
SET content = '<p style="margin: 0 0 10px 0; font-weight: bold;">
        ご利用いただきありがとうございます。
      </p>
