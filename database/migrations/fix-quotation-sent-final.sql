-- Fix Quotation Sent email template - Final version
-- 1. Add service type labels (CHARTER, SERVICE, etc.)
-- 2. Make magic link text white instead of blue
-- 3. Fix Next Steps numbers to be proper circles with better spacing
...
<div style="background: #FF2800; padding: 24px; border-radius: 8px; margin: 20px 0; text-align: center;box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1);">
  ...
  <div style="margin-top: 16px; padding-top: 16px; border-top: 1px solid rgba(255, 255, 255, 0.2);">
    ...
    <p style="margin: 0; font-size: 11px; word-break: break-all; background: rgba(255, 255, 255, 0.2); padding: 8px 12px; border-radius: 4px;"><a href="{{magic_link}}" class="magic-link" style="color: black !important; text-decoration: none !important;">{{magic_link}}</a></p>
  </div>
</div>

<!-- Official Quotation PDF Block -->
<div style="background: #ffffff; padding: 24px; border-radius: 8px; margin: 32px 0 24px 0; border: 1px solid #e2e8f0; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1);">
        ...
        <table cellpadding="0" cellspacing="0">
          <tr>
            <td style="vertical-align: top; padding-right: 16px;">
              <table cellpadding="0" cellspacing="0" style="background: #FF2800; width: 40px; height: 40px; border-radius: 8px;">
                <tr>
...
<!-- Next Steps -->
<div style="background: #f8fafc; padding: 24px; border-radius: 8px; margin: 32px 0 24px 0; border: 1px solid #e2e8f0;box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1);">
  <table width="100%" cellpadding="0" cellspacing="0">
    <tr>
      <td style="padding-bottom: 16px; border-bottom: 2px solid #f1f5f9;">
        <table cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td style="vertical-align: top;">
              ...
              <p style="margin: 4px 0 0; color: #718096; font-size: 14px;">{{language == "ja" ? "お客様の旅を完璧にするためのガイド" : "Your journey to perfection starts here"}}</p>
            </td>
          </tr>
        </table>
      </td>
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="margin-top: 24px; margin-bottom: 20px;">
    <tr>
      <td style="width: 40px; vertical-align: top; padding-right: 16px;">
        <table cellpadding="0" cellspacing="0" style="background: #2d3748; width: 28px; height: 28px; border-radius: 50%;">
          <tr>
            <td style="text-align: center; vertical-align: middle; width: 28px; height: 28px;">
      ...
      <td style="vertical-align: top;">
        <p style="margin: 0 0 6px 0; color: #2d3748; font-size: 15px; font-weight: 600; line-height: 1.4;">{{language == "ja" ? "見積書の詳細確認" : "Review Your Quotation"}}</p>
        <p style="margin: 0; color: #4a5568; font-size: 14px; line-height: 1.5;">{{language == "ja" ? "上記のセキュアリンクから見積書の詳細をご確認ください。" : "Click the secure link above to review your personalized quotation details."}}</p>
      </td>
    </tr>
  </table>
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 20px;">
    <tr>
      ...
      <td style="vertical-align: top;">
        <p style="margin: 0 0 6px 0; color: #2d3748; font-size: 15px; font-weight: 600; line-height: 1.4;">{{language == "ja" ? "ご質問・ご相談" : "Questions & Consultation"}}</p>
        <p style="margin: 0; color: #4a5568; font-size: 14px; line-height: 1.5;">{{language == "ja" ? "ご質問や調整が必要な場合は、専任のコンシェルジュチームが24時間以内にお答えします。" : "Our dedicated concierge team is available to answer any questions within 24 hours."}}</p>
      </td>
    </tr>
  </table>
  ...
  <table width="100%" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <td style="vertical-align: top;">
        <p style="margin: 0 0 6px 0; color: #2d3748; font-size: 15px; font-weight: 600; line-height: 1.4;">{{language == "ja" ? "予約確定・サービス提供" : "Confirmation & Service"}}</p>
        <p style="margin: 0; color: #4a5568; font-size: 14px; line-height: 1.5;">{{language == "ja" ? "お客様のご予約を確定し、卓越したサービス体験をお約束いたします。" : "We''ll confirm your reservation and deliver an unparalleled luxury service experience."}}</p>
      </td>
    </tr>
  </table>
  
  <div style="margin-top: 24px; padding-top: 16px; border-top: 1px solid #e2e8f0; text-align: center;">
    <p style="margin: 0; color: #718096; font-size: 13px; font-style: italic;">{{language == "ja" ? "お客様の満足が私たちの使命です" : "Your satisfaction is our commitment"}}</p>
  </div>
</div>

{{#if error}}
<div style="background: #ffffff; padding: 24px; border-radius: 8px; margin: 24px 0; border: 1px solid #e2e8f0;">
  <table width="100%" cellpadding="0" cellspacing="0">
    <tr>
      <td style="padding-bottom: 16px; border-bottom: 2px solid #f1f5f9;">
        <table cellpadding="0" cellspacing="0">
