  ...
  public: {
    Tables: {
      ...
      pdf_template_variables: {
        ...
        Relationships: [
          {
            foreignKeyName: "pdf_template_variables_template_id_fkey"
            columns: ["template_id"]
            isOneToOne: false
    ...
    Functions: {
      ...
      get_active_notification_templates: {
      ...
      get_active_templates: {
        Args: { template_team?: string; template_type?: string }
        Returns: {
          company_info: Json
          created_at: string
          description: string
