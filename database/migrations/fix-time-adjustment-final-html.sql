-- Final fix: Remove all time-based pricing logic from template and use pre-generated HTML
-- This completely bypasses the template engine's condition evaluation issues
...
SET html_content = REPLACE(
  ...
  '            <!-- Time-based Pricing Adjustment - Pre-generated HTML -->
...
-- Fix any remaining show_time_adjustment conditions
UPDATE notification_templates
SET html_content = REPLACE(
  html_content,
