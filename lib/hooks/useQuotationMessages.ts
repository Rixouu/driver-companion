...
// import { createServiceClient } from "@/lib/supabase/service-client"; // REMOVE this
// import { createBrowserClient } from '@supabase/ssr'; // REMOVE this
import { useSupabase } from "@/components/providers/supabase-provider"; // ADDED
...
export const useQuotationMessages = (quotationId: string) => {
  ...
  // Use useMemo to create a stable Supabase client instance for the browser
  // const supabase = useMemo(() => createBrowserClient( // REMOVED
