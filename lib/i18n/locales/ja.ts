...
export const ja: TranslationValue = {
  ...
  quotationInfo: {
    quotationStatus: "見積ステータス",
    status: "ステータス",
    expired: "期限切れ",
    convertedToBooking: "予約に変換済み",
    paid: "支払い済み",
    approved: "承認済み",
    rejected: "拒否済み",
    draft: "下書き",
    ...
    validForDays: "あと{days}日間有効",
    validUntil: "{date} {time}まで有効",
    created: "作成日"
  },
  approvalPanel: {
    title: "見積承認",
    description: "この見積を確認し、承認して進めるか、詳細なフィードバックとともに拒否してください。",
    approveButton: "承認",
    rejectButton: "拒否",
    decisionRecordedNotification: "💡 あなたの決定が記録され、結果が自動的に通知されます。",
    approveQuotation: "見積 #{quoteNumber} を承認",
    approveDescription: "確認して承認し、予約を進めてください。",
    rejectQuotation: "見積 #{quoteNumber} を拒否",
    rejectDescription: "この見積を拒否してもよろしいですか？",
    yourName: "お名前",
    yourNamePlaceholder: "署名用にお名前を入力してください",
    yourNameDescription: "これは署名プリセットと識別に使用されます。",
    notes: "メモ（オプション）",
    notesPlaceholder: "決定についてのメモやコメントを追加してください",
    bccEmails: "BCCメール",
    bccEmailsPlaceholder: "カンマで区切ってメールアドレスを入力",
    bccEmailsDescription: "デフォルト: booking@japandriver.com。カンマで区切ってメールアドレスを追加。",
    approvalSignature: "承認署名 *",
    rejectionReason: "拒否理由",
    rejectionReasonPlaceholder: "この見積を拒否する理由を提供してください",
    rejectionSignature: "拒否署名 *",
    reasonProvided: "✓ 理由が提供されました（{count}文字）",
    cancel: "キャンセル",
    processing: "処理中...",
    clearSignature: "クリア",
    showPresets: "プリセットを表示"
  ...
  workflowSteps: {
    ...
    approval: "承認",
    payment: "支払い",
    paymentDescription: "顧客に支払いリンクを送信または銀行振込方法を選択",
    confirmed: "確認済み",
    confirmedDescription: "見積が支払い済みとしてマークされました",
    converted: "変換済み",
    convertedDescription: "承認された見積を予約に変換",
    convertedStatusDescription: "見積が正常に予約に変換されました"
  },
  quotationDetails: {
    totalAmountBeforeDiscountTax: "割引・税込み前の合計金額:",
    notesAndComments: "メモとコメント",
    additionalInformationFeedback: "追加情報とフィードバック",
    customerNotes: "顧客メモ",
    customerNotesPlaceholder: "顧客メモ {name}",
    customerNotesDescription: "見積に表示される顧客向けメモ",
    internalNotes: "内部メモ",
    internalNotesPlaceholder: "内部メモ {name}",
    internalNotesDescription: "顧客には表示されない内部メモ",
    successfullyConvertedToBookings: "予約に正常に変換されました",
    successfullyConvertedToBooking: "予約に正常に変換されました",
    bookingsCreatedFromQuotation: "この見積から{count}件の予約が作成されました",
    bookingCreatedSuccessfully: "予約が正常に作成されました",
    failedToConvertToBooking: "予約への変換に失敗しました",
    pleaseTryAgainLater: "後でもう一度お試しください",
    expiresTomorrowSendReminderNow: "⚠️ 明日期限切れ - 今すぐリマインダーを送信",
    expiresInDaysConsiderSendingReminder: "⚠️ {days}日後に期限切れ - リマインダー送信を検討",
    expiresTodaySendReminderImmediately: "⚠️ 今日期限切れ - すぐにリマインダーを送信",
    expiredDaysAgo: "❌ {days}日前に期限切れ",
    notYet: "⏳ まだ{title}ではありません",
    generalNotes: "一般メモ",
    generalNotesDescription: "一般的なメモとコメント"
  },
  priceDetails: {
    selectedServices: "選択されたサービス",
    package: "パッケージ",
    ...
    charter: "チャーター",
    service: "サービス",
    timeBasedAdjustmentTitle: "時間ベース調整",
    rule: "ルール",
    ...
    hours: "時間",
    summary: "サマリー",
    servicesSubtotal: "サービス小計",
    totalAmountDue: "支払い総額",
    description: "説明",
    price: "価格",
    daySingular: "日",
    qty: "数量"
