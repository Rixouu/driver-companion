-- Phase 3A: Additional Missing Indexes
-- Supplementary indexes for optimal performance
...
-- User profiles: email for lookups
...
-- Pending maintenance tasks only
CREATE INDEX IF NOT EXISTS idx_maintenance_tasks_pending_due_date 
ON maintenance_tasks (due_date, created_at DESC) 
