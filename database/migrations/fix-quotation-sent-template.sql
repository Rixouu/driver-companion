-- Fix Quotation Sent template with proper icon centering and function support
...
<!-- Official Quotation PDF Block - Enhanced Design with Table-based Icon Centering -->
...
<!-- Next Steps - Clean Professional Design with Table-based Icon Centering -->
<div style="background: #f8fafc; padding: 24px; border-radius: 8px; margin: 24px 0; border: 1px solid #e2e8f0;box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1);">
  ...
  <div>
    ...
    <div style="display: flex; align-items: flex-start; gap: 16px; margin-bottom: 20px;">
      ...
      <div>
        <p style="margin: 0; color: #2d3748; font-size: 15px; font-weight: 600; line-height: 1.4;">{{language == "ja" ? "見積書の詳細確認" : "Review Your Quotation"}}</p>
        <p style="margin: 6px 0 0; color: #4a5568; font-size: 14px; line-height: 1.5;">{{language == "ja" ? "上記のセキュアリンクから見積書の詳細をご確認ください。" : "Click the secure link above to review your personalized quotation details."}}</p>
      </div>
    </div>
    ...
    <div style="display: flex; align-items: flex-start; gap: 16px; margin-bottom: 20px;">
      ...
      <div>
        <p style="margin: 0; color: #2d3748; font-size: 15px; font-weight: 600; line-height: 1.4;">{{language == "ja" ? "ご質問・ご相談" : "Questions & Consultation"}}</p>
        <p style="margin: 6px 0 0; color: #4a5568; font-size: 14px; line-height: 1.5;">{{language == "ja" ? "ご質問や調整が必要な場合は、専任のコンシェルジュチームが24時間以内にお答えします。" : "Our dedicated concierge team is available to answer any questions within 24 hours."}}</p>
      </div>
    </div>
    ...
    <div style="display: flex; align-items: flex-start; gap: 16px;">
      ...
      <div>
        <p style="margin: 0; color: #2d3748; font-size: 15px; font-weight: 600; line-height: 1.4;">{{language == "ja" ? "予約確定・サービス提供" : "Confirmation & Service"}}</p>
        <p style="margin: 6px 0 0; color: #4a5568; font-size: 14px; line-height: 1.5;">{{language == "ja" ? "お客様のご予約を確定し、卓越したサービス体験をお約束いたします。" : "We''ll confirm your reservation and deliver an unparalleled luxury service experience."}}</p>
      </div>
    </div>
  </div>
