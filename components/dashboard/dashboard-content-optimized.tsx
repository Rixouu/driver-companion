    ...
    <div className="space-y-8">
      ...
      {!isLoadingQuotations && expiringQuotations.length > 0 && (
        ...
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {/* Total Revenue */}
          <Card className="border border-emerald-200 dark:border-emerald-900/30 shadow-sm bg-gradient-to-br from-emerald-50 to-emerald-100/50 dark:from-emerald-900/20 dark:to-emerald-800/20">
          ...
          {/* Total Quotations */}
          <Card className="border border-blue-200 dark:border-blue-900/30 shadow-sm bg-gradient-to-br from-blue-50 to-blue-100/50 dark:from-blue-900/20 dark:to-blue-800/20">
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
          ...
          {/* Average Quote */}
          <Card className="border border-purple-200 dark:border-purple-900/30 shadow-sm bg-gradient-to-br from-purple-50 to-purple-100/50 dark:from-purple-900/20 dark:to-purple-800/20">
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
          ...
          {/* Conversion Rate */}
          <Card className="border border-orange-200 dark:border-orange-900/30 shadow-sm bg-gradient-to-br from-orange-50 to-orange-100/50 dark:from-orange-900/20 dark:to-orange-800/20">
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
