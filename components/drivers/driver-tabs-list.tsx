...
interface DriverTabsListProps {
  value?: string;
  onValueChange?: (value: string) => void;
}

export function DriverTabsList({ value, onValueChange }: DriverTabsListProps) {
  const { t } = useI18n();
  ...
  const tabs = [
    { value: "overview", label: t('drivers.tabs.overview'), icon: User },
    { value: "availability", label: t('drivers.tabs.availability'), icon: Calendar },
    { value: "bookings", label: "Bookings", icon: Truck },
    { value: "activity", label: t('drivers.tabs.activityLog'), icon: Activity },
  ];
