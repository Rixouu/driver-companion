...
export const ja: TranslationValue = {
  ...
  quotations: {
    ...
    form: {
      ...
      serviceUpdatedDescription: "サービスの詳細が正常に更新されました。"
    },
    pricing: {
      total: "合計金額",
      subtotal: "小計",
    ...
    details: {
      ...
      untitled: "無題の見積書",
      expires: "有効期限",
      expired: "{date}に有効期限切れ",
      info: "見積書情報",
      status: "見積書ステータス",
      noActivities: "まだ活動記録はありません",
      noFilteredActivities: "このタイプの活動は見つかりませんでした",
      approvalPanel: {
        title: "見積書承認",
        approveButton: "見積書を承認する",
        rejectButton: "見積書を拒否する",
        approveConfirmation: "この見積書を承認してもよろしいですか？",
        rejectConfirmation: "この見積書を拒否してもよろしいですか？",
        description: "この見積書を確認し、承認して進めるか、詳細なフィードバックを添えて拒否してください。",
        notesLabel: "備考（任意）",
        notesPlaceholder: "決定に関する備考やコメントを追加してください",
        reasonLabel: "拒否理由",
        reasonPlaceholder: "この見積書を拒否する理由を入力してください",
        approvalSuccess: "見積書が承認されました",
        rejectionSuccess: "見積書が拒否されました"
      }
    },
    status: {
      draft: "下書き",
  ...
  pricing: {
    title: "価格管理",
    description: "サービス価格、プロモーション、パッケージを管理する",
    categories: {
      title: "カテゴリー",
      description: "価格カテゴリーを管理する",
      createSuccess: "カテゴリーが正常に作成されました",
      createSuccessDescription: "新しいカテゴリーが追加されました",
      createError: "カテゴリーの作成に失敗しました",
      updateSuccess: "カテゴリーが正常に更新されました",
      updateSuccessDescription: "カテゴリーが更新されました",
      updateError: "カテゴリーの更新に失敗しました",
      deleteSuccess: "カテゴリーが正常に削除されました",
      deleteSuccessDescription: "カテゴリーが削除されました",
      deleteError: "カテゴリーの削除に失敗しました",
      deleteConfirmTitle: "カテゴリーを削除しますか？",
      deleteConfirmDescription: "この操作は元に戻せません。このカテゴリーは完全に削除され、既存の価格項目に影響する可能性があります。",
      activateConfirmTitle: "カテゴリーを有効化しますか？",
      activateConfirmDescription: "カテゴリーが表示され、選択可能になります。",
      deactivateConfirmTitle: "カテゴリーを無効化しますか？",
      deactivateConfirmDescription: "カテゴリーが新しい見積書や価格フォームでの選択から非表示になります。"
    },
    items: {
      title: "価格項目",
      description: "個々の価格項目を管理する",
      createSuccess: "価格項目が正常に作成されました",
      createSuccessDescription: "新しい価格項目が追加されました",
      createError: "価格項目の作成に失敗しました",
      updateSuccess: "価格項目が正常に更新されました",
      updateSuccessDescription: "価格項目が更新されました",
      updateError: "価格項目の更新に失敗しました",
      deleteSuccess: "価格項目が正常に削除されました",
      deleteSuccessDescription: "価格項目が削除されました",
      deleteError: "価格項目の削除に失敗しました",
      statusUpdateSuccess: "項目のステータスが更新されました",
      deleteConfirmTitle: "価格項目を削除しますか？",
      deleteConfirmDescription: "この操作は元に戻せません。この価格項目は完全に削除されます。",
      activateConfirmTitle: "価格項目を有効化しますか？",
      activateConfirmDescription: "価格項目が選択可能になります。",
      deactivateConfirmTitle: "価格項目を無効化しますか？",
      deactivateConfirmDescription: "価格項目が選択から非表示になります。無効化された項目は見積書に表示されません。",
      errors: {
        categoryRequired: "カテゴリーが必要です",
        serviceTypeRequired: "サービスタイプが必要です",
      ...
      timeBasedPricing: {
        title: "時間帯別料金",
        description: "時間帯に基づく価格調整を適用する",
        enabled: "時間帯別料金調整を有効にする",
        nightPricing: "夜間料金",
        nightPricingDescription: "夜間の時間帯にサービスの割増料金を適用する",
        startTime: "開始時間",
        endTime: "終了時間",
        adjustmentPercentage: "調整率（%）",
        peakPricing: "ピーク時間帯料金",
        peakPricingDescription: "ピーク時間帯にサービスの割増料金を適用する",
        weekendPricing: "週末料金",
        weekendPricingDescription: "週末にサービスの割増料金を適用する",
        holidayPricing: "休日料金",
        holidayPricingDescription: "休日にサービスの割増料金を適用する",
        addRule: "ルールを追加",
        editRule: "ルールを編集",
        deleteRule: "ルールを削除",
        deleteRuleConfirm: "このルールを削除してもよろしいですか？",
        ruleName: "ルール名",
        ruleNamePlaceholder: "ルールの名前を入力",
        days: {
          all: "すべての日",
          weekdays: "平日",
          weekends: "週末",
        ...
        rules: "料金ルール",
        noRules: "まだルールがありません。「ルールを追加」ボタンをクリックして最初のルールを作成してください",
        allCategories: "すべてのカテゴリー",
        specificCategory: "特定のカテゴリー",
        allServiceTypes: "すべてのサービスタイプ",
        specificServiceType: "特定のサービスタイプ",
        categoryLabel: "カテゴリー",
    ...
    promotions: {
      title: "プロモーション",
      description: "プロモーションコードと割引を管理する",
