-- Create PDF Templates table for centralized PDF template management
-- This allows managing PDF templates (quotations, invoices, reports) with translations and styling
...
INSERT INTO pdf_templates (name, type, category, description, template_data, translations, team, is_default) VALUES

-- Quotation Templates
('Standard Quotation', 'quotation', 'standard', 'Default quotation template with company branding', 
 '{
   "header": {
     "logo_url": "{{logo_url}}",
...
-- Invoice Templates
('Standard Invoice', 'invoice', 'standard', 'Default invoice template with company branding',
 '{
   "header": {
     "logo_url": "{{logo_url}}",
     "company_name": "{{company_name}}",
...
-- Create PDF template variables table for dynamic content
