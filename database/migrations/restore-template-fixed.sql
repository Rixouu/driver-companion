-- Complete template restoration with properly escaped quotes
-- This will fix the broken template
  ...
  <table width="100%" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <td style="vertical-align: top;">
        ...
        <p style="margin: 0; color: #4a5568; font-size: 14px; line-height: 1.5;">{{language == "ja" ? "お客様のご予約を確定し、卓越したサービス体験をお約束いたします。" : "We will confirm your reservation and deliver an unparalleled luxury service experience."}}</p>
      </td>
    </tr>
  </table>
