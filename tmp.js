  ...
  drivers: {
    ...
    inspections: {
      ...
      templates: {
        ...
        sectionNamePlaceholderJa: "例：エンジンシステム",
        sectionDescriptionLabel: "説明（任意）",
        sectionDescriptionPlaceholder: "セクションの簡単な説明",
        sectionDescriptionPlaceholderJa: "セクションの簡単な説明",
        ...
        itemNamePlaceholderJa: "例：オイルレベルの確認",
        itemDescriptionLabel: "項目の説明（任意）",
        itemDescriptionPlaceholder: "チェック内容の詳細",
        itemDescriptionPlaceholderJa: "チェック内容の詳細",
        requiresPhoto: "写真必須",
        requiresNotes: "メモ必須",
        ...
        editSectionDescription: "セクションの詳細を編集してください",
        editItemTitle: "項目を編集",
        editItemDescription: "点検項目の詳細を編集してください",
        routine: {
          title: "定期車両点検",
